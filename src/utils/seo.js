...
const defaultSEOConfig = {
  ...
  description: 'AgriConnect is a platform that connects farmers directly with consumers, providing fresh, local produce and supporting sustainable agriculture.',
  keywords: 'agriculture, farming, fresh produce, local food, sustainable farming, farm to table',
...
export const seoData = {
  home: {
    ...
    description: 'Discover fresh, locally grown produce directly from farmers. Support sustainable agriculture and enjoy farm-to-table quality with AgriConnect.',
    keywords: 'local produce, fresh vegetables, farmers market, sustainable farming, organic food, farm to table',
    type: 'website'
  },

  products: {
    title: 'Fresh Produce - AgriConnect Marketplace',
    description: 'Browse our wide selection of fresh, locally grown produce. From seasonal vegetables to organic fruits, find quality products from local farmers.',
    keywords: 'fresh produce, vegetables, fruits, organic food, local farmers, seasonal produce',
    type: 'website'
  },

  about: {
    title: 'About AgriConnect - Supporting Local Agriculture',
    description: 'Learn about AgriConnect\'s mission to connect farmers with consumers, promoting sustainable agriculture and supporting local communities.',
    keywords: 'about agriconnect, sustainable agriculture, local farming, community support, farm to table mission',
    type: 'website'
  },

  login: {
    title: 'Login - AgriConnect',
    description: 'Access your AgriConnect account to discover fresh local produce and connect with farmers in your area.',
    robots: 'noindex, nofollow'
  },

  register: {
    title: 'Join AgriConnect - Connect with Local Farmers',
    description: 'Create your AgriConnect account and start discovering fresh, local produce from farmers in your community.',
    keywords: 'join agriconnect, register account, local produce, farmer marketplace'
  },

  cart: {
    title: 'Shopping Cart - AgriConnect',
    description: 'Review your selected fresh produce and complete your order from local farmers.',
    robots: 'noindex, nofollow'
  },

  checkout: {
    title: 'Checkout - AgriConnect',
    description: 'Complete your purchase of fresh, local produce from AgriConnect farmers.',
    robots: 'noindex, nofollow'
  }
};
...
export const structuredData = {
  ...
  organization: {
    ...
    "@type": "Organization",
    "name": "AgriConnect",
    "description": "Platform connecting farmers with consumers for fresh, local produce",
    "url": window.location.origin,
  ...
  checkDescription: () => {
    ...
    return {
      ...
      recommendations: [
        ...
        length < 120 ? 'Description is too short (should be 120-160 characters)' : null,
        length > 160 ? 'Description is too long (should be 120-160 characters)' : null
      ].filter(Boolean)
    };
  },
