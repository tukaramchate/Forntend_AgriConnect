...
describe('ProductCard', () => {
  ...
  it('shows correct wishlist state when product is already in wishlist', () => {
    ...
    renderWithProviders(<ProductCard product={mockProduct} />, { store: storeWithWishlist });
  ...
  it('shows correct cart state when product is already in cart', () => {
    ...
    renderWithProviders(<ProductCard product={mockProduct} />, { store: storeWithCart });
  ...
  it('navigates to product details when clicked', () => {
    ...
    const titleLink = productLinks.find(link => link.href.includes('/products/1'));
