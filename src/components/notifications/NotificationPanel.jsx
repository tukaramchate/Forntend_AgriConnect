    ...
    <>
      ...
      <div className="fixed top-0 right-0 h-full w-96 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out">
        ...
        <div className="flex items-center justify-between p-4 border-b border-secondary-200">
          ...
          >
            <img src="/src/assets/icons/x.svg" alt="Close" className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex border-b border-secondary-200">
          {[
            ...
            { id: 'read', label: 'Read', count: inAppNotifications.length - unreadCount }
          ].map((tab) => (
            <button
              key={tab.id}
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <img src="/src/assets/icons/x.svg" alt="Remove" className="w-3 h-3" />
                      </button>
                    </div>
                  </div>
                </div>
