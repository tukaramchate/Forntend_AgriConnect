...
export default function Footer() {
  ...
  const handleSubscribe = useCallback(async (e) => {
    ...
    try {
      ...
      setStatus({ type: 'success', text: 'Successfully subscribed! Check your inbox for confirmation.' });
      setEmail('');
    } catch {
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12'>
          ...
          <div className='lg:col-span-1'>
            <div className='flex items-center gap-3 mb-4' id='footer-heading'>
              ...
              <div>
                <h2 className='font-bold text-xl text-secondary-900'>AgriConnect</h2>
            ...
            <p className='text-secondary-700 text-sm mb-6 leading-relaxed'>
              Empowering farmers with direct market access, fair pricing, and sustainable agriculture practices. 
              Building a stronger food supply chain together.
            </p>
          ...
          {/* Newsletter */}
          <div>
            <h3 className='font-semibold text-secondary-900 mb-4'>Stay Updated</h3>
            <p className='text-secondary-700 text-sm mb-4 leading-relaxed'>
              Get the latest updates on new products, seasonal offers, and farming tips.
            </p>
