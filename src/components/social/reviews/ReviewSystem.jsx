...
function ReviewSystem({
  ...
  return (
    <FadeIn className='review-system'>
      {/* Review Statistics */}
      <ReviewStats stats={reviewStats} targetType={targetType} />
...
function ReviewCard({ review, currentUserId }) {
  ...
  const [userFoundHelpful, setUserFoundHelpful] = useState(
            ...
            <div className='response-header'>
              ...
              <div className='merchant-info'>
                <span className='merchant-name'>
                  {review.merchantResponse.name}
                </span>
                <span className='response-date'>
                  {formatDate(review.merchantResponse.date)}
                </span>
              </div>
            </div>
        ...
        <form className='review-form' onSubmit={handleSubmit}>
          ...
          <div className='form-actions'>
            ...
            <InteractiveButton
              ...
              variant='primary'
              disabled={
                formData.rating === 0 || !formData.comment.trim() || submitting
              }
            >
  ...
  return [
    {
      ...
      comment:
        'I ordered the organic tomatoes and they were absolutely perfect. The taste was incredible - you can really tell the difference when produce is grown with care. The packaging was also excellent, everything arrived in perfect condition. Will definitely be ordering again!',
      images: [
      ...
      merchantResponse: {
        ...
        message:
          "Thank you so much for the wonderful review, Sarah! We're thrilled you enjoyed our tomatoes.",
    ...
    },
    {
      ...
      comment:
        'Really happy with the quality of the vegetables. Everything was fresh and well-packaged. Delivery was faster than expected. Only minor issue was that one item was slightly smaller than expected, but overall very satisfied.',
      verified: true,
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "This is my third order and I'm consistently impressed with the quality. The farmer clearly takes great care in growing and selecting their produce. The customer service is also excellent - they always respond quickly to any questions.",
      verified: true,
