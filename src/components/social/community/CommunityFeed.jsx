        ...
        const mockPosts = [
          {
            ...
            content:
              'Just harvested the most amazing tomatoes from our greenhouse! The new hydroponic system is working wonders. Here are some tips for anyone interested in starting their own hydroponic setup...',
            images: [
          ...
          },
          {
            ...
            content:
              "Weather alert: Heavy rains expected in the southwestern regions this week. Make sure to protect your crops and check drainage systems. Here's a quick checklist for storm preparation.",
            images: [],
            likes: 67,
            comments: 23,
            shares: 34,
          ...
          },
          {
            ...
            content:
              "Has anyone tried the new soil sensors from TechFarm? I'm considering investing in some IoT equipment for my corn fields.",
          ...
          },
          {
            ...
            content:
              "Excited to share our farm's carbon footprint report! We've reduced emissions by 30% this year through regenerative practices. Happy to answer questions about our methods.",
        ...
        {!showCreatePost ? (
          ...
          <div className='create-post-form'>
            ...
            <textarea
              ...
              maxLength={1000}
            />
            <div className='character-count'>{newPostText.length}/1000</div>
          ...
          <article key={post.id} className={`post-card ${post.type}`}>
            ...
            <div className='post-content'>
              ...
              {post.images.length > 0 && (
                <div
                  className={`post-images ${post.images.length > 1 ? 'multiple' : ''}`}
                >
