    ...
    const loadFarmerProfile = async () => {
      await handleAsyncError(
        async () => {
          ...
          // Simulate API calls
          const [farmerData, productsData, reviewsData, followData] = await Promise.all([
                    ...
                    {farmer.certifications.map((cert, index) => (
                      <div key={index} className="certification-item">
                        <div className="certification-badge">
                          <svg className="cert-icon" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                        </div>
              ...
              <div className="about-sidebar">
                  ...
                  <div className="contact-details">
                    <div className="contact-item">
                      ...
                      <div>
                        ...
                        <p className="contact-value">{farmer.location.address}</p>
                      </div>
                    </div>
                    ...
                    {farmer.contactInfo.phone && (
                      <div className="contact-item">
                        ...
                        <div>
                          ...
                          <p className="contact-value">{farmer.contactInfo.phone}</p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="contact-item">
                      ...
                      <div>
                        ...
                        <p className="contact-value">{farmer.contactInfo.email}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="farm-stats-card">
                  ...
                  <div className="farm-stats">
                    ...
                    <div className="farm-stat">
                      <span className="stat-number">{farmer.sustainabilityScore}/10</span>
              ...
              <div className="reviews-summary">
                <div className="rating-overview">
                  <div className="average-rating">
                    <span className="rating-number">{farmer.averageRating}</span>
                  ...
                  {review.farmerResponse && (
                    <div className="farmer-response">
                      <div className="response-header">
                        ...
                        />
                        <span className="response-label">Response from {farmer.name}</span>
                      </div>
...
async function fetchFarmerData(farmerId) {
  ...
  return {
    ...
    description: "Green Valley Farm has been a family-owned operation for over 50 years, committed to sustainable farming practices and providing the freshest, highest-quality produce to our community. We specialize in organic vegetables, seasonal fruits, and heritage grains grown with care for both the environment and our customers.",
    yearsExperience: 25,
    farmSize: 150,
    totalSales: "2.5K+",
    ...
    specialties: [
      {
        ...
        description: "Fresh, certified organic vegetables grown without pesticides",
    ...
    certifications: [
      ...
      { name: "Sustainable Agriculture Award", issuer: "California Farm Bureau", year: 2022 },
      { name: "Water Conservation Excellence", issuer: "State of California", year: 2023 }
    ],
    contactInfo: {
    ...
    galleryImages: [
      ...
      { url: "/api/placeholder/300/250", caption: "Our heritage tomato varieties" },
      { url: "/api/placeholder/300/250", caption: "Sustainable irrigation system" },
      { url: "/api/placeholder/300/250", caption: "Farm team at work" },
      { url: "/api/placeholder/300/250", caption: "Organic certification process" },
...
async function fetchFarmerProducts(farmerId) {
  ...
  return [
    ...
    },
    {
      ...
      description: "Rainbow variety heritage carrots with exceptional sweetness",
      price: 3.49,
      image: "/api/placeholder/250/200",
      isOrganic: true,
      inStock: true,
  ...
  return [
    {
      ...
      rating: 5,
      date: "2 weeks ago",
      comment: "Absolutely love the quality of produce from Green Valley Farm! The tomatoes are incredibly flavorful and you can really taste the difference. Will definitely be ordering again.",
      images: ["/api/placeholder/100/80", "/api/placeholder/100/80"],
      farmerResponse: "Thank you so much, Sarah! We're thrilled you enjoyed our tomatoes. It means the world to us when customers appreciate the care we put into our produce."
    },
    {
      id: 2,
      user: {
      ...
      rating: 5,
      date: "1 month ago",  
      comment: "Fast delivery and excellent customer service. The heritage carrots were amazing - my kids actually asked for more vegetables!",
      farmerResponse: "That's wonderful to hear, Mike! Getting kids excited about vegetables is one of our favorite success stories."
    },
    {
      id: 3,
      user: {
      ...
      rating: 4,
      date: "1 month ago",
      comment: "Great quality produce, though I wish there were more variety in the winter months. Overall very satisfied with my orders."
    }
  ];
}
