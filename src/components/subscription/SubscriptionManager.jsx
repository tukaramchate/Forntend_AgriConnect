        ...
        <div className='subscription-plans-section'>
          <div className='section-header'>
            ...
            <p className='section-description'>
              Choose from our curated subscription boxes and save on regular
              deliveries
            </p>
          </div>
          ...
          <div className='plans-grid'>
            {availablePlans.map((plan) => (
              <div
                key={plan.id}
                className={`plan-card ${plan.popular ? 'popular' : ''} ${plan.premium ? 'premium' : ''}`}
              >
                {plan.popular && (
            ...
            {subscriptions.map((subscription) => (
              <div key={subscription.id} className='subscription-card'>
                ...
                {subscription.customizations &&
                  subscription.customizations.length > 0 && (
                    <div className='customizations'>
                      <span className='customizations-label'>
                        Customizations:
                      </span>
                ...
                <div className='subscription-actions'>
                  {subscription.status === 'active' && (
                    <InteractiveButton
                      ...
                      size='small'
                      onClick={() =>
                        handlePauseResume(subscription.id, 'pause')
                      }
                      disabled={loading}
                    >
                      Pause
                  ...
                  {subscription.status === 'paused' && (
                    <InteractiveButton
                      ...
                      size='small'
                      onClick={() =>
                        handlePauseResume(subscription.id, 'resume')
                      }
                      disabled={loading}
                    >
                      Resume
