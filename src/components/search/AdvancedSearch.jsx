      ...
      <div className="container py-6">
            ...
            <div className="flex">
              <div className="relative flex-1">
                ...
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  <svg className="w-6 h-6" style={{ color: 'var(--neutral-400)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>
              </div>
              <Button type="submit" variant="primary" className="ml-4 px-8 py-4">
                Search
              </Button>
            </div>

            {/* Quick Search Suggestions */}
            <div className="absolute top-full left-0 right-0 bg-white shadow-lg rounded-b-lg border border-t-0 z-10 hidden group-focus-within:block" style={{ borderColor: 'var(--neutral-200)' }}>
              <div className="p-4">
                <div className="text-sm font-medium mb-2" style={{ color: 'var(--neutral-700)' }}>Popular Searches</div>
                <div className="flex flex-wrap gap-2">
                  {['Organic Vegetables', 'Fresh Fruits', 'Farm Milk', 'Local Honey', 'Seasonal Produce'].map((suggestion) => (
                    <button
                      key={suggestion}
                      onClick={() => {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm" style={{ color: 'var(--neutral-600)' }}>Sort by:</span>
            <select
        ...
        {isFilterOpen && (
          <div className="mt-6 p-6 bg-neutral-50 rounded-lg border" style={{ borderColor: 'var(--neutral-200)' }}>
