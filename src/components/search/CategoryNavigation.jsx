  ...
  return (
    ...
    >
      <div className='container py-6'>
        ...
        <div
          className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6 ${!isExpanded ? 'mb-0' : ''}`}
        >
          {(isExpanded ? allCategories : allCategories.slice(0, 6)).map(
            (category) => (
              <button
                key={category.id}
              ...
              >
                {/* Background Gradient */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${category.color} opacity-5 rounded-xl group-hover:opacity-10 transition-opacity`}
                ></div>
                ...
                <div className='relative text-center'>
                  ...
                  <Badge
                    variant={
                      activeCategory === category.id ? 'success' : 'info'
                    }
                    className='text-xs'
                  >
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {selected.subcategories.map((sub, index) => (
                      <button
                        key={index}
                        onClick={() =>
                          onCategorySelect({ ...selected, subcategory: sub })
                        }
          ...
          <div className='mt-8 grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            >
              <div className='relative z-10'>
                ...
                <button
                  onClick={() =>
                    handleCategoryClick({ id: 'seasonal', name: 'Seasonal' })
                  }
            ...
            >
              <div className='relative z-10'>
                <div className='flex items-center gap-2 mb-2'>
                  <span className='text-2xl'>🌱</span>
                  <Badge variant='success' className='text-xs bg-white/20'>
                    Certified
                  </Badge>
                </div>
