...
function ErrorHandlingDemo() {
  ...
  const handleCriticalError = () => {
    handleError(new Error('Database connection failed'), {
      ...
      showToUser: true,
      logToService: true,
      customMessage: 'We are experiencing technical difficulties. Our team has been notified.'
    });
  };
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-xl font-semibold mb-4">Form Validation & Error Handling</h2>
        <div className="space-y-4">
          <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          <p className="text-gray-600 text-sm">
            These buttons demonstrate different types of error handling and user feedback patterns.
          </p>
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
        ...
        <div className="text-sm text-gray-600 space-y-2">
          <p><strong>Active Errors:</strong> {isErrorActive() ? 'Yes' : 'No'}</p>
          <p><strong>Environment:</strong> Demo Mode</p>
          <p><strong>Error Logging:</strong> Console Only</p>
          <p><strong>Toast Position:</strong> Top Right</p>
        </div>
      </div>
    </div>
  );
