 ...
 */
const LoyaltyProgram = ({ userId, onRewardRedeem }) => {
      ...
      try {
        ...
        const mockRewards = [
          ...
          },
          {
            ...
            description:
              'Guided tour of organic farms with family (for 4 people)',
            pointsCost: 3000,
            category: 'experience',
            available: false,
        ...
        const mockAchievements = [
          ...
          },
          {
            ...
            title: 'Eco Warrior',
            description:
              'Save 50kg of packaging by choosing eco-friendly options',
            points: 400,
            unlocked: false,
            progress: 32,
            target: 50,
  ...
  const getTierInfo = (tier) => {
    const tiers = {
      Bronze: {
        color: '#cd7f32',
        nextPoints: 1000,
        benefits: ['Basic support', '2% cashback'],
      },
      Silver: {
        color: '#c0c0c0',
        nextPoints: 2000,
  ...
  const getTierProgress = () => {
    ...
    const currentTierPoints =
      getTierInfo(
        userLoyalty.currentTier === 'Bronze'
          ? 'Bronze'
          : userLoyalty.currentTier === 'Silver'
            ? 'Bronze'
            : userLoyalty.currentTier === 'Gold'
              ? 'Silver'
              : 'Gold'
      ).nextPoints || 0;

    const progress =
      ((userLoyalty.totalPointsEarned - currentTierPoints) /
        (tierInfo.nextPoints - currentTierPoints)) *
      100;
        ...
        <div className='points-overview'>
            ...
            <div className='points-expiry'>
              {userLoyalty.pointsExpiring > 0 && (
                <div className='expiry-warning'>
                  ...
                  {userLoyalty.pointsExpiring} points expiring on{' '}
                  {userLoyalty.expiryDate.toLocaleDateString()}
                </div>
              )}
            </div>
          </div>
          ...
          <div className='tier-card'>
            <div
              ...
              style={{
                backgroundColor: getTierInfo(userLoyalty.currentTier).color,
              }}
            >
        ...
        <div className='loyalty-stats'>
          <div className='stat-item'>
            <span className='stat-value'>
              ₹{userLoyalty.totalSavings.toLocaleString()}
            </span>
          ...
          <div className='stat-item'>
            <span className='stat-value'>
              {userLoyalty.totalPointsEarned.toLocaleString()}
            </span>
          ...
          <div className='overview-tab'>
            <div className='tier-benefits'>
              ...
              <div className='benefits-list'>
                {getTierInfo(userLoyalty.currentTier).benefits.map(
                  (benefit, index) => (
                  ...
                  <div className='reward-image'>
                    ...
                    {!reward.available && reward.availableFrom && (
                      <div className='availability-overlay'>
                        Available from{' '}
                        {reward.availableFrom.toLocaleDateString()}
                      </div>
                    )}
                  </div>
                  ...
                  <div className='reward-content'>
                    ...
                    {reward.expiryDays && (
                      <p className='reward-expiry'>
                        Expires in {reward.expiryDays} days after redemption
                      </p>
                    )}
                  </div>
                </div>
        ...
        {activeTab === 'history' && (
          <div className='history-tab'>
            <p className='coming-soon'>
              Points history and transaction details coming soon!
            </p>
          </div>
        )}
      </div>
