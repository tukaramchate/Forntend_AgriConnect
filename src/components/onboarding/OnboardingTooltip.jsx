...
const OnboardingTooltip = ({
  ...
  }, [isVisible, currentStep, totalSteps, showSkip, onNext, onPrevious, onSkip]);
  ...
  const tooltipContent = (
    <>
      ...
      >
        ...
        <div className="p-6">
          {title && (
            <h3 id="tooltip-title" className="text-lg font-semibold text-gray-900 mb-3">
              {title}
            </h3>
          )}
          
          {content && (
            <p id="tooltip-content" className="text-gray-600 mb-4 leading-relaxed">
              {content}
            </p>
          )}
