  ...
  const demoCards = [
    {
      ...
      description:
        'Welcome new customers with a guided tour of shopping features',
      icon: '🛒',
      color: 'blue',
      features: [
        ...
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Experience our comprehensive onboarding flows designed to welcome
              and guide different types of users through their AgriConnect
              journey.
            </p>
          </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-start space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600 text-sm'>
                        Different onboarding experiences for customers, farmers,
                        and admins
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600 text-sm'>
                        Context-aware guidance with element highlighting
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600 text-sm'>
                        Skip, resume, and track completion status
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600 text-sm'>
                        Easy to customize steps, styling, and behavior
                      </p>
                    </div>
                  </div>
                </div>
