  ...
  const steps = [
    {
      ...
      description:
        "Your gateway to fresh, local produce directly from farmers. Let's get you started on your journey to better, healthier food.",
      variant: 'centered',
      tips: [
    ...
    },
    {
      ...
      description:
        'Browse our marketplace to find seasonal vegetables, fruits, and organic products from verified local farmers.',
      image:
        'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&h=300&fit=crop&auto=format',
      actions: (
        <div className='space-y-3'>
          <div className='p-3 bg-green-50 rounded-lg border border-green-200'>
            ...
            <p className='text-sm text-green-700'>
              Find the best seasonal produce available now
            </p>
          </div>
          <div className='p-3 bg-blue-50 rounded-lg border border-blue-200'>
            <h4 className='font-medium text-blue-900 mb-1'>🔍 Smart Filters</h4>
            <p className='text-sm text-blue-700'>
              Filter by location, price, organic certification, and more
            </p>
          </div>
        </div>
      ),
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin='round'
            strokeWidth={2}
            d='M3 3h2l.4 2M7 13h10l4-8H5.4m1.4 4h10'
          />
        </svg>
      ),
      title: 'Add Items to Your Cart',
      description:
        'Found something you like? Simply click the "Add to Cart" button. You can adjust quantities and review your selection anytime.',
      actions: (
    ...
    },
    {
      ...
      description:
        'Review your order, choose delivery options, and complete your purchase securely. We support multiple payment methods for your convenience.',
      actions: (
        <div className='space-y-3'>
    ...
    },
    {
      ...
      description:
        'Manage your profile, track orders, save favorite farmers, and access exclusive deals. Your personalized agricultural marketplace awaits!',
      variant: 'centered',
      actions: (
