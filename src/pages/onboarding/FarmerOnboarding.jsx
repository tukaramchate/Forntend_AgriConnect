...
const FarmerOnboarding = ({ 
  ...
  const handleComplete = () => {
    completeOnboarding();
    showSuccess('Welcome to AgriConnect! Your farmer profile is ready to start selling.');
    onComplete();
  };
  ...
  const steps = [
    {
      ...
      description: 'Join thousands of farmers who are already selling their fresh produce directly to customers. Let\'s set up your profile and get you started on your digital agriculture journey.',
      variant: 'centered',
      image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&h=300&fit=crop&auto=format',
      tips: [
    ...
    },
    {
      icon: (
        <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H9m0 0H7m2 0v-2a2 2 0 012-2h2a2 2 0 012 2v2z" />
        </svg>
      ),
      title: 'Set Up Your Farm Profile',
      description: 'Tell customers about your farm! A complete profile builds trust and helps customers discover your products.',
      children: (
    ...
    },
    {
      ...
      description: 'Showcase your organic certifications, quality standards, and farming credentials to build customer trust and command premium prices.',
      actions: (
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <label key={cert.id} className="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:bg-green-50 cursor-pointer transition-colors">
                <input
                  type="checkbox"
                  ...
                  onChange={(e) => {
                    if (e.target.checked) {
                      ...
                      setFormData(prev => ({
                        ...prev,
                        certifications: prev.certifications.filter(c => c !== cert.id)
                      }));
                    }
                  }}
                />
          ...
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm text-amber-800">
                <strong>Pro Tip:</strong> Certified products typically sell for 20-30% higher prices. Upload your certificate documents in your profile settings.
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      description: 'Add your produce to the marketplace! Start with your best seasonal items. Good photos and descriptions help customers choose your products.',
      actions: (
        <div className="bg-gray-50 rounded-lg p-4">
          <h4 className="font-medium text-gray-900 mb-3">Quick Product Setup</h4>
          <div className="space-y-3">
    ...
    },
    {
      icon: (
        <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m6 4V7a2 2 0 00-2-2H6a2 2 0 00-2 2v4m0 0v8a2 2 0 002 2h12a2 2 0 002-2v-8M8 11h8" />
        </svg>
      ),
      title: 'Set Up Delivery Options',
      description: 'Configure how customers can receive their orders. Offer multiple options to reach more customers and increase sales.',
      actions: (
        <div className="space-y-4">
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Direct to customer's door</p>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <input type="text" placeholder="₹50" className="w-16 text-xs border rounded px-1" />
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Customer collects from location</p>
                </div>
              </div>
              <div className="space-y-2">
                <input 
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm text-blue-800">
                <strong>Tip:</strong> Offering both delivery and pickup options increases your sales by up to 40%. Consider partnering with local stores for additional pickup points.
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      description: 'Welcome to your command center! Monitor sales, manage inventory, track earnings, and grow your agricultural business with powerful insights.',
      variant: 'centered',
      actions: (
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <div className="text-sm text-green-700 mt-1">Track performance & trends</div>
          </div>
          
          <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="text-3xl mb-2">📦</div>
            <div className="font-medium text-blue-900">Order Management</div>
            <div className="text-sm text-blue-700 mt-1">Process & fulfill orders</div>
          </div>
          
          <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
            <div className="text-3xl mb-2">💰</div>
            <div className="font-medium text-purple-900">Earnings Overview</div>
            <div className="text-sm text-purple-700 mt-1">Monitor income & payouts</div>
          </div>
          
          <div className="text-center p-4 bg-orange-50 rounded-lg border border-orange-200">
            <div className="text-3xl mb-2">👥</div>
            <div className="font-medium text-orange-900">Customer Insights</div>
            <div className="text-sm text-orange-700 mt-1">Build customer relationships</div>
          </div>
        </div>
      ),
      tips: [
