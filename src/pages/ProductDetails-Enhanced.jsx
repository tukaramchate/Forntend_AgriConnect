...
import { Button, Card, CardBody, Badge, Modal, Alert, Breadcrumb } from '../components/ui';
...
const ProductDetailsEnhanced = () => {
  ...
  const farmerStory = {
    ...
    story: 'I have been practicing organic farming for over two decades. My family has been farming this land for generations, and we believe in sustainable practices that not only produce the best quality vegetables but also preserve our soil for future generations.',
    achievements: ['Organic Certification', 'Best Farmer Award 2023', 'Sustainable Farming Pioneer'],
    ...
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          const relatedResponse = await productAPI.getRelatedProducts(productData.category, id);
          ...
          if (mockProduct) {
            ...
            const related = mockProducts
              .filter(p => p.category === adaptedProduct.category && p.id !== adaptedProduct.id)
              .slice(0, 4)
              .map(p => ({
                ...p,
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--neutral-50)' }}>
      <div className="container py-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-2 text-sm" style={{ color: 'var(--neutral-600)' }}>
            ...
            <div className="flex items-center gap-4">
              <div className="text-3xl font-bold" style={{ color: 'var(--primary-600)' }}>
                ₹{product.price}
                <span className="text-base font-normal ml-1" style={{ color: 'var(--neutral-600)' }}>
                  per {product.unit}
                </span>
              </div>
              {product.originalPrice && (
                <div className="text-lg line-through" style={{ color: 'var(--neutral-400)' }}>
                  ₹{product.originalPrice}
                </div>
              )}
            </div>
            ...
            {/* Short Description */}
            <div>
              <p style={{ color: 'var(--neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <label className="font-medium" style={{ color: 'var(--neutral-700)' }}>
                  Quantity:
                </label>
        ...
        <div className="mb-12">
          <div className="border-b" style={{ borderColor: 'var(--neutral-200)' }}>
          ...
          <div className="py-8">
            {selectedTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="mb-4" style={{ color: 'var(--neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
                  {product.description}
                </p>
                <p className="mb-4" style={{ color: 'var(--neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
                  This premium quality {product.name.toLowerCase()} is carefully selected and harvested at the perfect time 
                  to ensure maximum freshness and nutritional value. Our farmers use sustainable farming practices that 
                  respect the environment while producing the highest quality produce.
                </p>
                <h4 className="font-semibold mb-2">Key Features:</h4>
                <ul className="list-disc pl-6 space-y-1" style={{ color: 'var(--neutral-700)' }}>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium mb-2" style={{ color: 'var(--neutral-700)' }}>
                          Rich in Vitamins:
                        </h5>
                        <div className="flex flex-wrap gap-2">
                ...
                <Card className="p-6">
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-semibold mb-2">{farmerStory.name}</h4>
                      <div className="flex flex-wrap gap-2 mb-4">
                        <Badge variant="warning">{farmerStory.experience}</Badge>
                  ...
                  {[
                    {
                      ...
                      rating: 5,
                      date: '2 days ago',
                      comment: 'Excellent quality! Very fresh and exactly as described. Will definitely order again.',
                      verified: true
                    },
                    {
                      name: 'Rajesh Kumar',
                      rating: 4,
                      date: '1 week ago',
                      comment: 'Good product, delivered on time. Packaging could be better but overall satisfied.',
                      verified: true
                    },
                    {
                      name: 'Anita Gupta',
                      rating: 5,
                      date: '2 weeks ago',
                      comment: 'Amazing freshness! You can really taste the difference when it comes directly from the farm.',
                      verified: true
                    }
                  ].map((review, index) => (
                    <Card key={index} className="p-6">
                      ...
                      <p style={{ color: 'var(--neutral-700)' }}>{review.comment}</p>
                    </Card>
                  ))}
                </div>
              </div>
            ...
            {selectedTab === 'shipping' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <Card className="p-6">
                    <h4 className="font-semibold mb-4 flex items-center gap-2">
                      <svg className="w-5 h-5" style={{ color: 'var(--primary-500)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                      </svg>
                      Shipping Information
                    </h4>
                    <div className="space-y-3 text-sm" style={{ color: 'var(--neutral-700)' }}>
                      <div className="flex justify-between">
                ...
                <div className="mt-8 p-6 rounded-lg" style={{ backgroundColor: 'var(--info-50)' }}>
                  <h4 className="font-semibold mb-2 flex items-center gap-2" style={{ color: 'var(--info-700)' }}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm" style={{ color: 'var(--info-700)' }}>
                    All our produce is harvested fresh and delivered within 24-48 hours. If you're not completely 
                    satisfied with the freshness and quality, we'll provide a full refund or replacement.
                  </p>
                </div>
              </div>
            )}
        ...
        {relatedProducts.length > 0 && (
          <section>
            <h2 className="text-2xl font-bold mb-8" style={{ color: 'var(--neutral-900)' }}>
              Related Products
            </h2>
            ...
            <div className="flex gap-1">
              {[1, 2, 3, 4, 5].map((rating) => (
                <button
                  ...
                  className={`w-8 h-8 ${
                    rating <= newReview.rating ? 'text-yellow-400' : 'text-neutral-300'
                  }`}
                >
