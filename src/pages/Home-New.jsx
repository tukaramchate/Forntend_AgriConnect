...
const mockProducts = [
  ...
  },
  {
    ...
    price: 80,
    image: 'https://images.unsplash.com/photo-1518569656558-1f25e69d93d7?w=400&h=300&fit=crop&auto=format',
    rating: 4.7,
  ...
  },
  {
    ...
    price: 40,
    image: 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&h=300&fit=crop&auto=format',
    rating: 4.4,
...
const Home = () => {
  ...
  const categories = [
    { id: 1, name: 'Vegetables', icon: '🥕', count: 45, description: 'Fresh local vegetables', color: 'from-green-400 to-green-600' },
    { id: 2, name: 'Fruits', icon: '🍎', count: 32, description: 'Seasonal fresh fruits', color: 'from-red-400 to-red-600' },
    { id: 3, name: 'Dairy', icon: '🥛', count: 18, description: 'Farm fresh dairy products', color: 'from-blue-400 to-blue-600' },
    { id: 4, name: 'Grains', icon: '🌾', count: 23, description: 'Organic grains & cereals', color: 'from-yellow-400 to-yellow-600' },
    { id: 5, name: 'Organic', icon: '🌱', count: 56, description: 'Certified organic produce', color: 'from-emerald-400 to-emerald-600' },
    { id: 6, name: 'Herbs', icon: '🌿', count: 28, description: 'Fresh aromatic herbs', color: 'from-lime-400 to-lime-600' },
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      avatar: 'https://images.unsplash.com/photo-1494790108755-2616b96b2c8b?w=64&h=64&fit=crop&auto=format'
    },
    {
      id: 2,
      name: 'Rajesh Patel',
  ...
  const farmerSpotlights = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1569913486515-b74bf7751574?w=300&h=300&fit=crop&auto=format',
  ...
  return (
    <main className="min-h-screen" role="main">
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--primary-50) 0%, var(--primary-100) 100%)' }}>
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-20 h-20 rounded-full opacity-10 animate-pulse" style={{ backgroundColor: 'var(--primary-500)' }}></div>
          <div className="absolute bottom-10 right-10 w-32 h-32 rounded-full opacity-10 animate-pulse" style={{ backgroundColor: 'var(--secondary-500)' }}></div>
          <div className="absolute top-1/2 left-1/4 w-16 h-16 rounded-full opacity-10 animate-pulse delay-1000" style={{ backgroundColor: 'var(--primary-600)' }}></div>
        </div>
        ...
        <div className="container relative py-20 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold mb-6" style={{ color: 'var(--neutral-900)', lineHeight: 'var(--leading-tight)' }}>
                Fresh From
                <span className="block" style={{ color: 'var(--primary-500)' }}>Farm to Table</span>
              </h1>

              <p className="text-xl mb-8" style={{ color: 'var(--neutral-600)', lineHeight: 'var(--leading-relaxed)' }}>
                Connect directly with local farmers and get fresh, organic produce delivered to your doorstep. 
                Supporting farmers, serving freshness.
              </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-8">
                {[
                  ...
                  <div key={index} className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
            ...
            <div className="relative">
              ...
              {/* Floating Stats */}
              <div className="absolute -top-4 -left-4 text-white rounded-xl p-4 shadow-lg" style={{ backgroundColor: 'var(--primary-600)' }}>
                <div className="text-2xl font-bold">500+</div>
                <div className="text-sm opacity-90">Happy Farmers</div>
              </div>
              <div className="absolute -bottom-4 -right-4 text-white rounded-xl p-4 shadow-lg" style={{ backgroundColor: 'var(--secondary-500)' }}>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <Badge variant="info" className="mb-4">Fresh Categories</Badge>
            <h2 className="text-4xl font-bold mb-4" style={{ color: 'var(--neutral-900)' }}>
              Shop by Category
            </h2>
            <p className="text-lg" style={{ color: 'var(--neutral-600)' }}>
              Discover fresh produce from various categories, all sourced directly from local farmers
            </p>
          </div>
            ...
            {categories.map((category) => (
              <Link key={category.id} to={`/categories/${category.name.toLowerCase()}`}>
                <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                  ...
                  <h3 className="font-semibold mb-2" style={{ color: 'var(--neutral-900)' }}>
                    {category.name}
                  </h3>
      ...
      <section className="py-20" style={{ backgroundColor: 'var(--neutral-50)' }}>
        <div className="container">
          <div className="text-center mb-12">
            <Badge variant="success" className="mb-4">Best Sellers</Badge>
            <h2 className="text-4xl font-bold mb-4" style={{ color: 'var(--neutral-900)' }}>
              Featured Products
            </h2>
            <p className="text-lg" style={{ color: 'var(--neutral-600)' }}>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <Badge variant="warning" className="mb-4">Meet Our Farmers</Badge>
            <h2 className="text-4xl font-bold mb-4" style={{ color: 'var(--neutral-900)' }}>
              Farmer Spotlights
            </h2>
            <p className="text-lg" style={{ color: 'var(--neutral-600)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {farmerSpotlights.map((farmer) => (
              <Card key={farmer.id} className="overflow-hidden group">
                ...
                <CardBody>
                  <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--neutral-900)' }}>
                    {farmer.name}
                  </h3>
                  <p className="text-sm mb-2" style={{ color: 'var(--neutral-500)' }}>
                    📍 {farmer.location}
                  </p>
      ...
      <section className="py-20" style={{ backgroundColor: 'var(--neutral-50)' }}>
        <div className="container">
          <div className="text-center mb-12">
            <Badge variant="info" className="mb-4">Our Promise</Badge>
            <h2 className="text-4xl font-bold mb-4" style={{ color: 'var(--neutral-900)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="text-center p-6 group hover:shadow-lg transition-all duration-300">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: 'var(--primary-100)' }}>
                  <span className="text-3xl">{feature.icon}</span>
                </div>
                <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--neutral-900)' }}>
                  {feature.title}
                </h3>
                <p className="mb-4" style={{ color: 'var(--neutral-600)', lineHeight: 'var(--leading-relaxed)' }}>
                  {feature.description}
                </p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <Badge variant="warning" className="mb-4">Happy Customers</Badge>
            <h2 className="text-4xl font-bold mb-4" style={{ color: 'var(--neutral-900)' }}>
                ...
                {testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="w-full flex-shrink-0">
                    <Card className="p-8 text-center">
                      ...
                      <blockquote className="text-xl mb-6" style={{ color: 'var(--neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
                        "{testimonial.text}"
                      </blockquote>
      ...
      {/* CTA Section */}
      {!isAuthenticated && (
        <section className="py-20 text-white" style={{ background: 'linear-gradient(135deg, var(--primary-600) 0%, var(--primary-700) 100%)' }}>
