        ...
        <section className="demo-section">
          ...
          <div className="demo-grid">
            ...
            <div className="demo-item">
              ...
              <span>{t('navigation.home')} | {t('navigation.products')} | {t('navigation.about')}</span>
            </div>
          </div>
        </section>
        ...
        <section className="demo-section">
          ...
          <div className="demo-grid">
            <div className="demo-item">
              ...
              <span>{formatNumber(sampleData.price, { minimumFractionDigits: 2 })}</span>
            </div>
            <div className="demo-item">
          ...
          <div className="demo-card">
            ...
            <div className="product-demo">
              <div className="product-info">
                <span className="product-name">{t('demo.ecommerce.productName', 'Organic Tomatoes')}</span>
                <span className="product-price">{formatCurrency(45)} / {t('demo.ecommerce.unit', 'kg')}</span>
              </div>
              <div className="product-actions">
                <button className="btn-primary">{t('products.addToCart')}</button>
                <button className="btn-secondary">{t('products.addToWishlist')}</button>
              </div>
            </div>
          </div>
        </section>
