...
const mockCartItems = [
  {
    ...
    price: 45,
    image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=150&h=150&fit=crop&auto=format',
    quantity: 2,
    unit: 'kg',
    stock: 50,
  ...
  },
  {
    ...
    price: 60,
    image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=150&h=150&fit=crop&auto=format',
    quantity: 1,
    unit: 'liter',
    stock: 20,
    farmer: 'Gopal Dairy',
  ...
  },
  {
    ...
    price: 120,
    image: 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=150&h=150&fit=crop&auto=format',
    quantity: 1,
    unit: 'kg',
    stock: 30,
    ...
    return (
      <div className="min-h-screen bg-secondary-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-secondary-600">Loading your cart...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-secondary-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center px-4">
          ...
          <h2 className="text-2xl font-bold text-secondary-900 mb-3">Your cart is empty</h2>
          <p className="text-secondary-600 mb-8">
            Looks like you haven't added any products to your cart yet. Discover fresh, organic produce from local farmers!
          </p>
  ...
  return (
    <div className="min-h-screen bg-secondary-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-secondary-900 mb-2">Shopping Cart</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border border-secondary-200 overflow-hidden">
              ...
              <div className="divide-y divide-secondary-100">
                {cartItems.map((item) => (
                  <div key={item.id} className="p-6 hover:bg-secondary-25 transition-colors duration-200">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-secondary-200 sticky top-4">
              <div className="p-6 border-b border-secondary-100">
                <h3 className="text-xl font-semibold text-secondary-900">Order Summary</h3>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 border-t border-secondary-200 space-y-3">
                  <h4 className="font-medium text-secondary-900 text-sm">Why shop with us?</h4>
