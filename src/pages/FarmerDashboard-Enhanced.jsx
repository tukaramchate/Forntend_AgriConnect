...
const FarmerDashboardEnhanced = () => {
  ...
  const orderHeaders = ['Order ID', 'Customer', 'Items', 'Amount', 'Status', 'Date'];
  const orderActions = [
    {
      label: 'Process',
  ...
  const inventoryHeaders = ['Product Name', 'Stock Level', 'Price', 'Status', 'Last Updated'];
  ...
  return (
    <div className="min-h-screen bg-secondary-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-secondary-900">Farmer Dashboard</h1>
                <p className="text-secondary-600 mt-1">Manage your farm business and track performance</p>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                  <div className="h-64 bg-secondary-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-secondary-600 mb-2">Sales Analytics Chart</p>
                      <p className="text-sm text-secondary-500">Revenue and order volume visualization</p>
                    </div>
                  </div>
                </ChartCard>
              </div>
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-8">
            <h2 className="text-xl font-semibold text-secondary-900">Analytics & Insights</h2>
            
            {/* Analytics Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <ChartCard title="Revenue Trends" subtitle="Monthly revenue over the last 6 months">
              ...
              <ChartCard title="Top Products" subtitle="Best selling products this month">
                <div className="h-48 bg-secondary-100 rounded-lg flex items-center justify-center">
                  <p className="text-secondary-600">Product Performance Chart</p>
                </div>
              </ChartCard>
              
              <ChartCard title="Customer Demographics" subtitle="Your customer base analysis">
                <div className="h-48 bg-secondary-100 rounded-lg flex items-center justify-center">
                  <p className="text-secondary-600">Demographics Chart</p>
                </div>
              </ChartCard>
              
              <ChartCard title="Seasonal Trends" subtitle="Product demand throughout the year">
                <div className="h-48 bg-secondary-100 rounded-lg flex items-center justify-center">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-secondary-900">Community Feed</h3>
                <Link 
                  to="/community" 
        ...
        {activeTab === 'profile' && (
          <div className="max-w-2xl">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <h3 className="text-lg font-semibold text-secondary-900 mb-6">Farmer Profile</h3>
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-secondary-700 mb-2">Farm Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-secondary-700 mb-2">Farmer Name</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-secondary-700 mb-2">Farm Description</label>
                  <textarea
                    rows={4}
