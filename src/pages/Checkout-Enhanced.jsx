...
const CheckoutEnhanced = () => {
  ...
  const { items: cartItems, coupon } = useSelector(
    (state) => state.cart || { items: [], coupon: null }
  );
  ...
  const validateShipping = () => {
    ...
    else if (!/^\d{10}$/.test(shippingData.phone.replace(/\s+/g, '')))
                ...
                <div className='p-6'>
                  ...
                  <div className='space-y-4 mb-6'>
                    ...
                    <div
                      ...
                      onClick={() =>
                        handleInputChange('payment', 'method', 'upi')
                      }
                    >
                      <div className='flex items-center gap-3 mb-4'>
                        <input
                    ...
                    <div
                      ...
                      onClick={() =>
                        handleInputChange('payment', 'method', 'netbanking')
                      }
                    >
                      <div className='flex items-center gap-3 mb-4'>
                        <input
