...
const UserDashboard = () => {
  ...
  const activities = [
    ...
    },
    {
      ...
      description: 'Fresh organic spinach is now available from your favorite farmer',
  ...
  const orderHeaders = ['Order ID', 'Date', 'Items', 'Total', 'Status', 'Farmer'];
  const orderActions = [
    {
      label: 'View',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-secondary-900">Welcome back, John!</h1>
                <p className="text-secondary-600 mt-1">Here's what's happening with your orders today.</p>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                  <div className="h-64 bg-secondary-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-secondary-600 mb-2">Order History Chart</p>
                      <p className="text-sm text-secondary-500">Chart visualization would go here</p>
                    </div>
                  </div>
                </ChartCard>
              </div>
        ...
        {activeTab === 'orders' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-secondary-900">Order History</h2>
        ...
        {activeTab === 'wishlist' && (
          <div className="text-center py-12">
            <img src="/src/assets/icons/heart.svg" alt="" className="w-16 h-16 mx-auto opacity-50 mb-4" />
            <h3 className="text-lg font-medium text-secondary-900 mb-2">Your Wishlist</h3>
            <p className="text-secondary-600 mb-6">Save products you love for later</p>
            <Link
              to="/products"
        ...
        {activeTab === 'profile' && (
          <div className="max-w-2xl">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <h3 className="text-lg font-semibold text-secondary-900 mb-6">Profile Settings</h3>
              <div className="space-y-6">
