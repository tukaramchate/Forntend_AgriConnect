...
const NotificationDemo = () => {
  ...
  const demoNotifications = [
    {
      title: 'Success Toast',
      action: () => notifications.showSuccess('This is a success message!', { duration: 3000 })
    },
    {
      title: 'Error Toast',
      action: () => notifications.showError('Something went wrong!', { 
        title: 'Error',
    ...
    {
      title: 'Warning Toast',
      action: () => notifications.showWarning('This is a warning message!', { duration: 4000 })
    },
    {
      title: 'Info Toast',
      action: () => notifications.showInfo('Here\'s some information for you', { duration: 5000 })
    },
    {
      title: 'Persistent Notification',
      action: () => notifications.showInfo('This notification will stay in your inbox', {
        title: 'Persistent Message',
        persistent: true,
        showToast: true,
        actions: [{ label: 'View Details', onClick: () => console.log('Details clicked') }]
      })
    },
    {
      title: 'Order Placed',
    ...
    },
    {
      ...
      action: () => notificationService.orderStatusUpdate('OD-1234', 'shipped', 'Tomorrow 2PM')
    },
    {
    ...
    },
    {
      ...
      action: () => notificationService.newOrderReceived('OD-5678', 'John Doe', 650)
    },
    {
    ...
    {
      title: 'System Alert',
      action: () => notificationService.systemAlert('Database maintenance scheduled for tonight', 'warning')
    },
    {
      title: 'Welcome User',
    ...
    {
      title: 'New Promotion',
      action: () => notificationService.newPromotion('Flash Sale', 'All vegetables', 25)
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
            <h3 className="text-lg font-semibold text-secondary-900 mb-2">Active Toasts</h3>
            <p className="text-2xl font-bold text-primary-600">{notifications.toasts.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
            <h3 className="text-lg font-semibold text-secondary-900 mb-2">In-App Notifications</h3>
            <p className="text-2xl font-bold text-info-600">{notifications.inAppNotifications.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
            <h3 className="text-lg font-semibold text-secondary-900 mb-2">Unread Count</h3>
            <p className="text-2xl font-bold text-error-600">{notifications.unreadCount}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {demoNotifications.map((demo, index) => (
              ...
              >
                ...
                <p className="text-sm text-secondary-600 mt-1">Click to trigger</p>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <NotificationPreferences 
            ...
            initialPreferences={{
              ...
              inApp: { orderUpdates: true, promotions: true, newProducts: true }
            }}
          />
        </div>
      </div>
