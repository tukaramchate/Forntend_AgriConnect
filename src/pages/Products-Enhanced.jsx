    ...
    const applyFiltersAndSort = () => {
      ...
      switch (filters.sortBy) {
        ...
        case 'popular':
          ...
          filtered.sort(
            (a, b) =>
              b.rating * (b.reviews || 10) - a.rating * (a.reviews || 10)
          );
          break;
        default:
        ...
        <div className='container'>
          <div className='text-center max-w-3xl mx-auto'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Discover a wide variety of fresh, organic produce sourced directly
              from trusted farmers in your area
            </p>
      ...
      {!isAuthenticated && filteredProducts.length > 0 && (
        ...
        >
          <div className='container text-center'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Create an account to start shopping and enjoy exclusive member
              benefits
            </p>
